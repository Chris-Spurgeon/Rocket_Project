...
r_o = 6671;    % Orbit radius in km
k = 0.36;     % Growth rate (adjustable) Needs changing depending on orbit, smaller orbit=larger k and vice versa

% Function for f(r) with a delayed transition
f = @(r) (pi/2) * (1 ./ (1 + exp(-k * 0.15*(r - r_o))));
